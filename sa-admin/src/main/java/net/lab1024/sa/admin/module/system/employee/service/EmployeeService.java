...
//        }
        ...
        String password1 = employeeAddForm.getPassword1();
        String password2 = employeeAddForm.getPassword2();
        if(!password1.equals(password2)){
            return ResponseDTO.userErrorParam("密码不一致");
        }

        EmployeeEntity entity = SmartBeanUtil.copy(employeeAddForm, EmployeeEntity.class);
        // 设置密码 默认密码
        entity.setLoginPwd(getEncryptPwd(password1));
